...
def S1astar(S1a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    # F holds the implicit equation on (c_e, S1a) used to calculate S1a
    F = S1a**2*(phi_1*phi_7 + phi_4)**2*(2*S1a**2*phi_6 + S1a*phi_1 + S1a - 1) + S1a**2*(phi_1*phi_7 + phi_4)**2 + S1a*(phi_1*phi_7 + phi_4)*(2*S1a**2*phi_6 + S1a*phi_1 + S1a + phi_2*(2*S1a**2*phi_6 + S1a*phi_1 + S1a - 1) - 1) - 2*phi_5*(2*S1a**2*phi_6 + S1a*phi_1 + S1a - 1)**2
    # F = (phi_1*phi_7*s1a*(phi_1*phi_7*s1a + phi_2 + phi_4*s1a - sqrt(phi_1**2*phi_7**2*s1a**2 + 2*phi_1*phi_2*phi_7*s1a + 2*phi_1*phi_4*phi_7*s1a**2 + 2*phi_1*phi_7*s1a + phi_2**2 + 2*phi_2*phi_4*s1a + 2*phi_2 + phi_4**2*s1a**2 + 2*phi_4*s1a + 8*phi_5 + 1) + 1) + phi_4*s1a*(phi_1*phi_7*s1a + phi_2 + phi_4*s1a - sqrt(phi_1**2*phi_7**2*s1a**2 + 2*phi_1*phi_2*phi_7*s1a + 2*phi_1*phi_4*phi_7*s1a**2 + 2*phi_1*phi_7*s1a + phi_2**2 + 2*phi_2*phi_4*s1a + 2*phi_2 + phi_4**2*s1a**2 + 2*phi_4*s1a + 8*phi_5 + 1) + 1) + 4*phi_5*(-phi_1*s1a - 2*phi_6*s1a**2 - s1a + 1))/(4*phi_5)
    return F 
...
def S1a(phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    ...
    # the root of S1astar
    # S1a = newton(S1astar, x0=0.001, args=(phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n) ,fprime=S1astarPrime, fprime2=S1astarPrime2,maxiter=100, tol=1e-5, rtol=1e-5)
    S1a = brentq(S1astar, a=0, b=1, args=(phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n), xtol=1e-30, maxiter=300)
    # if S1a < 1e-10:
    #     S1a=0
    return S1a


S1a = np.vectorize(S1a)

def S2a(s1a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    # return -(2*s1a**2*phi_6 + s1a*phi_1 + s1a - 1)/(s1a*(phi_1*phi_7 + phi_4))
    return -(phi_1*phi_7*s1a + phi_2 + phi_4*s1a + 1)/(4*phi_5) + sqrt(phi_1**2*phi_7**2*s1a**2 + 2*phi_1*phi_2*phi_7*s1a + 2*phi_1*phi_4*phi_7*s1a**2 + 2*phi_1*phi_7*s1a + phi_2**2 + 2*phi_2*phi_4*s1a + 2*phi_2 + phi_4**2*s1a**2 + 2*phi_4*s1a + 8*phi_5 + 1)/(4*phi_5)

def S21(s1a, s2a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    return s1a*s2a*phi_1*phi_7

def S12(s1a, s2a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    return s1a*s2a*phi_4

def S11(s1a, s2a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    return s1a**2*phi_6

def S22(s1a, s2a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    return  s2a**2*phi_5

def S1(s1a, s2a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    return s1a*phi_1

def S2(s1a, s2a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n):
    return  s2a*phi_2
...
# STIM expressions
s1a = S1a(phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n)
s2a = S2a(s1a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n)
...
s1 = S1(s1a, s2a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n)
s2 = S2(s1a, s2a, phi_1, phi_2, phi_3, phi_4, phi_5, phi_6, phi_7, c_e, n)
