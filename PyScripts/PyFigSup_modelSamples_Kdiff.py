...
#% Data collection
"""
Collecting data for the WT, S1 (S2KO), S2 (S1KO) versions of the model - modified diffusion
"""
Vplc = [0.06, 0.1, 0.15, 0.2, 0.25]
par = parJurkatCell()
par['kdiff'] = 0.008 # 0.004
par['VsM'] = 0.3 # 0.2
tf = 250
WT = []
for V in Vplc:
