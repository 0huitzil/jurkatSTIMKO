...
eq3 = S1**2 - exp(-n*k11)*S11
eq4 = S2**2 - exp(-n*k22)*S22
...
s21 = s21.subs(S1a, s1a).subs(S2a, s2a)
s12 = s12.subs(S1a, s1a).subs(S2a, s2a)
...
eq7 = eq7.subs(S1a, s1a).subs(S2a, s2a).subs(S12, s12).subs(S21, s21).subs(S11, s11).subs(S22, s22)
eq8 = eq8.subs(S1a, s1a).subs(S2a, s2a).subs(S12, s12).subs(S21, s21).subs(S11, s11).subs(S22, s22)
#%%
"""
...
"""
S1Print = S1Star.subs(S1a, Symbol('s1'))
S2Print = S2Star.subs(S1a, Symbol('s2'))
...
S1aPrint = s1a.subs(ph1, phi1).subs(ph2, phi2).subs(ph3, phi3).subs(ph4, phi4).subs(ph5, phi5).subs(ph6, phi6).subs(ph7, phi7)
S2aPrint = s2a.subs(ph1, phi1).subs(ph2, phi2).subs(ph3, phi3).subs(ph4, phi4).subs(ph5, phi5).subs(ph6, phi6).subs(ph7, phi7)
