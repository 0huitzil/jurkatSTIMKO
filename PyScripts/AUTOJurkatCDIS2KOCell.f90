...
!     ---------- ----
      ...
      !cm
      F(3)=gammaM*(delta*s*i - JsercaM - Jdiff)
      !h
      F(4)=Jh/Th
      !p 
      F(5)=(Vplc - IPdeg*p)/Tp
      ...
      DFDU(3,4)= 0
      DFDU(3,5)= 0
      DFDU(3,6)= delta*gammaM*i
      DFDU(3,7)= delta*gammaM*s
      ...
      DFDU(5,7)= 0
      DFDU(6,1)= 0
      DFDU(6,2)= -n*w1*exp(n*(-K1 + ce))/(Ts*(exp(n*(-K1 + ce)) + 1)**2)
      DFDU(6,3)= 0
      DFDU(6,4)= 0
      DFDU(6,5)= 0
      DFDU(6,6)= -1/Ts
      ...
      DFDU(7,1)= 0
      DFDU(7,2)= 0
      DFDU(7,3)= -si*exp(si*(-Ki + cm))/(Ti*(exp(si*(-Ki + cm)) + 1)**2)
      DFDU(7,4)= 0
      DFDU(7,5)= 0
      DFDU(7,6)= 0
      DFDU(7,7)= -1/Ti
